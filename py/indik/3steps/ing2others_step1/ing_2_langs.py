...
def ing_2_langs(sfdroot,encoding,ftype):
    ...
    for lang in languages:
        ...
        ffobz_lang.paste()
        ########
        ffobz_inglish.selection.select(("ranges", None), "a", "z")
        ffobz_inglish.copy()
        ffobz_lang.selection.select(("ranges", None), "a", "z")
        ffobz_lang.paste()
        ########
        # ffobz_inglishonlyw8.selection.select(("ranges", None), 0x80, 0x9F)
        # ffobz_inglishonlyw8.copy()
